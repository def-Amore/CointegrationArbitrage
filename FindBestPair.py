...
for i in range(101, 602, 100):
    ...
    print(f'Period: {20210300 + i} to {20220300 + i}')
    co_ints = find_cointegration(data, (20210300 + i, 20220300 + i),
                                 trading_period=(20220200 + i, 20220000 + (800 + i) // 1200 * 10100 + (800 + i) % 1200))
